...
rk3588tpl : rk3588tpl_start.S  main.c
	$(CC) -D__ASSEMBLY__ -DCONFIG_ARM64 -nostdinc -fno-builtin -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a+nosimd -g -c -o rk3588tpl_start.o  rk3588tpl_start.S
